...
fn glossary_data() -> Vec<GlossaryEntry> {
    vec![
        ...
        GlossaryEntry { id:"nayin-jiazi", term_zh:"甲子乙丑海中金", term_en:"JiaZi YiChou Gold in the Sea", category:"nayin", description_zh:"六十甲子纳音之首。甲子、乙丑属金，为海中金，象征深藏不露的珍贵。" },
        GlossaryEntry { id:"nayin-bingyin", term_zh:"丙寅丁卯炉中火", term_en:"BingYin DingMao Fire in the Furnace", category:"nayin", description_zh:"丙寅、丁卯属火，为炉中火，象征冶炼锻造之能。" },
        GlossaryEntry { id:"nayin-wuchen", term_zh:"戊辰己巳大林木", term_en:"WuChen JiSi Great Forest Wood", category:"nayin", description_zh:"戊辰、己巳属木，为大林木，象征茂盛广阔。" },
        GlossaryEntry { id:"nayin-gengwu", term_zh:"庚午辛未路旁土", term_en:"GengWu XinWei Roadside Earth", category:"nayin", description_zh:"庚午、辛未属土，为路旁土，象征承载通行。" },
        GlossaryEntry { id:"nayin-renshen", term_zh:"壬申癸酉剑锋金", term_en:"RenShen GuiYou Sword-Edge Gold", category:"nayin", description_zh:"壬申、癸酉属金，为剑锋金，象征锋利决断。" },
        GlossaryEntry { id:"nayin-jiaxu", term_zh:"甲戌乙亥山头火", term_en:"JiaXu YiHai Mountaintop Fire", category:"nayin", description_zh:"甲戌、乙亥属火，为山头火，象征高远光明。" },
        GlossaryEntry { id:"nayin-bingzi", term_zh:"丙子丁丑涧下水", term_en:"BingZi DingChou Stream Water", category:"nayin", description_zh:"丙子、丁丑属水，为涧下水，象征清流不息。" },
        GlossaryEntry { id:"nayin-wuyin", term_zh:"戊寅己卯城头土", term_en:"WuYin JiMao Rampart Earth", category:"nayin", description_zh:"戊寅、己卯属土，为城头土，象征坚固防御。" },
        GlossaryEntry { id:"nayin-gengchen", term_zh:"庚辰辛巳白蜡金", term_en:"GengChen XinSi White Wax Gold", category:"nayin", description_zh:"庚辰、辛巳属金，为白蜡金，象征精致细腻。" },
        GlossaryEntry { id:"nayin-renwu", term_zh:"壬午癸未杨柳木", term_en:"RenWu GuiWei Willow Wood", category:"nayin", description_zh:"壬午、癸未属木，为杨柳木，象征柔韧优美。" },
        GlossaryEntry { id:"nayin-jiashen", term_zh:"甲申乙酉泉中水", term_en:"JiaShen YiYou Spring Water", category:"nayin", description_zh:"甲申、乙酉属水，为泉中水，象征源源不断。" },
        GlossaryEntry { id:"nayin-bingxu", term_zh:"丙戌丁亥屋上土", term_en:"BingXu DingHai Roof Earth", category:"nayin", description_zh:"丙戌、丁亥属土，为屋上土，象征庇护安居。" },
        GlossaryEntry { id:"nayin-overview", term_zh:"纳音", term_en:"Na Yin", category:"nayin", description_zh:"六十甲子纳音，将六十干支组合分为三十组，每组配以五行和形象比喻。用于命理推演中的五行力量参考和性格分析。" },
    ]
}
